def calculate_deductions(comparison_results, claim_type):
    ...
    Each deduction dict: {"item_name": str, "amount": float, "reason": str}
    """
    ...
    for result in comparison_results:
        if not result.get("is_prescribed", True):
            ...
            if amount is None:
                # If price wasn't part of the comparison result, skip amount calc,
                # but still flag it as an issue for manual review.
                continue
